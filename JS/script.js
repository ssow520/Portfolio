...
const projects = {
  ...
  appmobile: {
    ...
    title: 'Livraison',
    tag: 'Android/Java',
    desc: 'Application Android de gestion de livraison de journeaux développée en Android avec XML. Architecture DRY avec un singleton Donnees, navigation par destination et vues modulaires conformes aux exigences du cours.',
    stack: ['Android', 'XML', 'Android Studio', 'Mobile'],
  ...
  quizapp: {
    ...
    title: 'Quiz App',
    tag: 'PHP / MySQL',
    desc: 'Application web de quiz multi-utilisateurs développée en PHP avec XAMPP. Deux types de comptes : administrateur (CRUD complet sur les quiz) et utilisateur (participation, scores, statistiques et export des résultats en fichier téléchargeable).',
